...
function calendarEvent(root: CompositionRoot): Parameters<typeof calendarLoad>[0] {
...
function lessonContextEvent(href: string): Parameters<typeof lessonContextLoad>[0] {
